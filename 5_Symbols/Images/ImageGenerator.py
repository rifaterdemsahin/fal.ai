        ...
        return [
            ...
            },
            {
                ...
                "prompt": (
                    ...
                    "'UNKNOWN PROBLEM' box with question mark icon â†’ 'SYMBOL/MODEL' box with diagram icon â†’ "
                    "'n8n SIMULATION' box with workflow icon â†’ 'TESTING/VALIDATION' box with checkmark icon, "
            ...
            },
            {
                ...
                "prompt": (
                    ...
                    "'PREVIOUS STATE' (database cylinder icon) â†’ 'CURRENT INPUT' (arrow icon) â†’ "
                    "'STATE COMPARISON' (equals/not-equals icon) â†’ 'DECISION' (fork/branch icon) â†’ "
